...
namespace AnularCancelarOrdenCompra
{
    ...
    /// </summary>
    [CodedUITest]
    public class AnularCancelacionOrdenCompra
    {
        public AnularCancelacionOrdenCompra()
        {
        }

        [TestMethod]
        public void CUITAnularCancelacionOrdenCompra()
        {
            ...
            this.UIMap.SeleccionarOrdendecomprayAnularlaCancelaciondecomprobante();
            this.UIMap.Aceptar();
