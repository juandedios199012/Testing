...
namespace AnularOrdenCompra
{
    /// <summary>
    /// Descripción resumida de CodedUITest1
    /// </summary>
    [CodedUITest]
    public class AnularOrdenCompra
    {
        public AnularOrdenCompra()
        {
        }

        [TestMethod]
        public void CUITAnularOrdenCompra()
        {
            uICodedUI.Menu2("FlexBusiness ERP 4.2 - 4110000", "explorerBar", "COMPRAS", "Operaciones", "Ordenes de compra", "Ordenes de compra - Aprobadas");
            uICodedUI.Lista("FlexBusiness ERP 4.2 - 4110000", "frmVistaAdministrativaListView2", "UltraListView1", "005-0009013");
            uICodedUI.Comando("FlexBusiness ERP 4.2 - 4110000", "Anular Comprobante");
